window.func=function(lib,game,ui,get,ai,_status){
	lib.extensionMenu.extension_特效测试['ts']={
		"name":"<b><p align=center><span style=\"font-size:18px\">----提示(game.say1)----</span></b>",
		"clear":true,
		"nopointer":true,
	};
	lib.extensionMenu.extension_特效测试['ts_show']={
		"name":"提示记录栏",
		"init":true,
		"intro":"开启后，鼠标移至(电脑端)/点击(移动端)最右边滑出提示记录栏",
    };
	if(lib.config['extension_特效测试_ts_show']!=false){
	...
	game.say1=function(str,num){
		...
		var func=function(){
			...
			setTimeout(function(){
				if(lib.config['extension_特效测试_ts_show']!=false&&dialog_log!=undefined){
